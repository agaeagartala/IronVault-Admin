...
use crate::AppWindow; // generated by slint::include_modules!() in main.rs
...
// Convenience re-export so handler modules can just `use crate::context::*;`
pub type SharedContext = Arc<AppContext>;

#[allow(unused_imports)]
pub(crate) use AppWindow as _AppWindowMarker; // keeps the import intentional/documented
